...
INSERT INTO DIMON_CALENDARS (CALENDAR_NAME,CALENDAR_SASCODE,UPDATE_USER,UPDATE_DTS) VALUES ('Businessdays@Sys', 'weekday(d) >= 1 and weekday(d) <= 6', USER, CURRENT_TIMESTAMP);
