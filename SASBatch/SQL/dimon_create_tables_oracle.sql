CREATE TABLE "EOMORAOWNER"."DIMON_CALENDARS" 
   ("CALENDAR_NAME" VARCHAR2(100), 
	"CALENDAR_SASCODE" VARCHAR2(1024), 
...
CREATE TABLE "EOMORAOWNER"."DIMON_FLOW_JOB" 
   ("FLOW_JOB_ID" VARCHAR2(255) NOT NULL ENABLE, 
	"FLOW_JOB_NAME" VARCHAR2(255), 
	"FLOW_ID" VARCHAR2(20), 
	"JOB_ID" VARCHAR2(20), 
	"JOB_SEQ_NR" SMALLINT, 
...
CREATE TABLE "EOMORAOWNER"."DIMON_FLOW_SCHEDULES" 
   ("FLOW_ID" VARCHAR2(20), 
	"TRIGGERING_EVENT_TRANSFER_ROLE" VARCHAR2(10), 
	"TRIGGERING_EVENT_ROLE" VARCHAR2(20), 
	"TRIGGERING_EVENT_CONDITION" VARCHAR2(100), 
...
CREATE TABLE "EOMORAOWNER"."DIMON_FLOWS" 
   ("FLOW_ID" VARCHAR2(20) NOT NULL ENABLE, 
	"FLOW_NAME" VARCHAR2(100), 
	"FLOW_DESC" VARCHAR2(200), 
	"VALID_FROM_DTS" TIMESTAMP, 
	"VALID_UNTIL_DTS" TIMESTAMP, 
	"CURRENT_IND" VARCHAR2(1), 
	"UPDATE_USER" VARCHAR2(32), 
...
CREATE TABLE "EOMORAOWNER"."DIMON_JOB_RUNS" 
   ("JOB_RUN_ID" INTEGER NOT NULL ENABLE, 
	...
	"FLOW_JOB_ID" VARCHAR2(255), 
	"JOB_START_DTS" TIMESTAMP (6), 
	"JOB_END_DTS" TIMESTAMP (6), 
	"JOB_LOG_FILE" VARCHAR2(1024), 
	"JOB_LST_FILE" VARCHAR2(1024), 
...
CREATE TABLE "EOMORAOWNER"."DIMON_JOB_STATUS" 
   ("JOB_STATUS_ID" SMALLINT NOT NULL ENABLE, 
	"JOB_STATUS_CODE" VARCHAR2(12), 
	"JOB_STATUS_DESC" VARCHAR2(32), 
...
CREATE TABLE "EOMORAOWNER"."DIMON_TIMEZONES" 
   ("TIMEZONE" VARCHAR2(32), 
	"CONDITION_SASCODE" VARCHAR2(1024), 
...
CREATE TABLE "EOMORAOWNER"."DIMON_NAV_ITEMS" 
   ("NAV_ITEM_NR" SMALLINT,
	"NAV_ITEM_CODE" VARCHAR2(8), 
	"NAV_ITEM_DESC" VARCHAR2(32), 
	"NAV_ITEM_URL" VARCHAR2(255), 
	"UPDATE_USER" VARCHAR2(32), 
	"UPDATE_DTS" TIMESTAMP,
...
CREATE TABLE "EOMORAOWNER"."DIMON_FLOW_LABELS"
   ("FLOW_ID" VARCHAR2(20),
    "LABEL" VARCHAR2(100),
    "DIMON_USER" VARCHAR2(100),
    "UPDATE_USER" VARCHAR2(32),
    "UPDATE_DTS" TIMESTAMP,
    CONSTRAINT "PK_DIMON_FLOW_LABELS" PRIMARY KEY ("FLOW_ID", "LABEL", "DIMON_USER")
);

CREATE TABLE "EOMORAOWNER"."DIMON_FLOW_ALERTS"
   ("FLOW_ALERT_ID" SMALLINT,
    "FLOW_ID" VARCHAR2(20),
    "ALERT_CONDITION" VARCHAR2(100),
    "ALERT_CONDITION_OPERATOR" VARCHAR2(10),
    "ALERT_CONDITION_VALUE" SMALLINT,
    "ALERT_ACTION" VARCHAR2(100),
    "ALERT_ACTION_DETAILS" VARCHAR2(200),
    "DIMON_USER" VARCHAR2(100),
    "UPDATE_USER" VARCHAR2(32),
    "UPDATE_DTS" TIMESTAMP,
