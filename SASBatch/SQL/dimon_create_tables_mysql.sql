...
CREATE TABLE `DIMON_FLOW_JOB` (
  ...
  `JOB_SEQ_NR` smallint DEFAULT NULL,
...
CREATE TABLE `DIMON_FLOW_SCHEDULES` (
  ...
  `TRIGGERING_EVENT_CONDITION` varchar(100) NOT NULL DEFAULT '',
...
CREATE TABLE `DIMON_JOB_RUNS` (
  ...
  `JOB_STATUS_ID` smallint DEFAULT NULL,
  `JOB_RC` smallint DEFAULT NULL,
  `UPDATE_USER` varchar(32) DEFAULT NULL,
  `UPDATE_DTS` datetime DEFAULT NULL,
...
CREATE TABLE `DIMON_JOB_STATUS` (
  `JOB_STATUS_ID` smallint NOT NULL DEFAULT '0',
...
CREATE TABLE `DIMON_TIMEZONES` (
  ...
  `TIMEDIFF` smallint NOt NULL DEFAULT 0,
  `UPDATE_USER` varchar(32) DEFAULT NULL,
  `UPDATE_DTS` datetime DEFAULT NULL,
  PRIMARY KEY (`TIMEZONE`,`TIMEDIFF`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `DIMON_NAV_ITEMS` (
  `NAV_ITEM_NR` smallint NOT NULL DEFAULT '0',
  `NAV_ITEM_CODE` varchar(8) DEFAULT NULL,
  `NAV_ITEM_DESC` varchar(32) DEFAULT NULL,
  `NAV_ITEM_URL` varchar(255) DEFAULT NULL,
  `UPDATE_USER` varchar(32) DEFAULT NULL,
  `UPDATE_DTS` datetime DEFAULT NULL,
  PRIMARY KEY (`NAV_ITEM_NR`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `DIMON_FLOW_LABELS`
( `FLOW_ID` varchar(20) NOT NULL DEFAULT '',
  `LABEL` varchar(100) NOT NULL DEFAULT '',
  `DIMON_USER` varchar(100) NOT NULL DEFAULT '',
  `UPDATE_USER` varchar(32) DEFAULT NULL,
  `UPDATE_DTS` datetime DEFAULT NULL,
  PRIMARY KEY (`FLOW_ID`,`LABEL`,`DIMON_USER`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `DIMON_FLOW_ALERTS`
(
  `FLOW_ALERT_ID` smallint NOT NULL DEFAULT 0,
  `FLOW_ID` varchar(20) NOT NULL DEFAULT '',
