...
PROC SQL;
  CREATE TABLE DIMON.DIMON_NAV_ITEMS
    ...
    ,  NAV_ITEM_CODE CHAR(8) NOT NULL
    ,  NAV_ITEM_DESC CHAR(32) NOT NULL
    ,  NAV_ITEM_URL CHAR(255) NOT NULL
    ,  UPDATE_USER CHAR(32)
    ,  UPDATE_DTS NUMERIC FORMAT=DATETIME19. INFORMAT=DATETIME19.
    )
  ;
...
PROC SQL;
  CREATE TABLE DIMON.DIMON_FLOW_ALERTS
    (  FLOW_ALERT_ID NUMERIC NOT NULL
    ,  FLOW_ID CHAR(20) NOT NULL
    ,  ALERT_CONDITION CHAR(100) NOT NULL
    ,  ALERT_CONDITION_OPERATOR CHAR(10)
    ,  ALERT_CONDITION_VALUE NUMERIC
    ,  ALERT_ACTION CHAR(100) NOT NULL
    ,  ALERT_ACTION_DETAILS CHAR(200)
    ,  DIMON_USER CHAR(100) NOT NULL
    ,  UPDATE_USER CHAR(32)
    ,  UPDATE_DTS NUM FORMAT=DATETIME19. INFORMAT=DATETIME19.
    )
  ;
  CREATE UNIQUE INDEX flow_alert_id ON DIMON.DIMON_FLOW_ALERTS(flow_alert_id);
QUIT;

PROC SQL;
  CREATE TABLE DIMON.DIMON_FLOW_LABELS
    ( FLOW_ID CHAR(20) NOT NULL
  ...
  ;
  CREATE UNIQUE INDEX PK_DIMON_FLOW_LABELS ON DIMON.DIMON_FLOW_LABELS(FLOW_ID, LABEL, DIMON_USER);
QUIT;
