...
PROC SQL;
  CREATE TABLE DIMON.DIMON_NAV_ITEMS
    (  NAV_ITEM_NR NUM
    ,  NAV_ITEM_CODE CHAR(8)
    ,  NAV_ITEM_DESC CHAR(32)
    ,  NAV_ITEM_URL CHAR(255)
    ,  UPDATE_USER CHAR(32)
    ,  UPDATE_DTS NUM FORMAT=DATETIME19. INFORMAT=DATETIME19.
    )
  ;
  CREATE UNIQUE INDEX NAV_ITEM_NR ON DIMON.DIMON_NAV_ITEMS(NAV_ITEM_NR);
QUIT;
